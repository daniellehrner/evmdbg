...
var handlers = map[vm.OpCode]vm.Handler{
	...
	vm.EXTCODESIZE:    &ExtCodeSizeOpCode{},
	vm.EXTCODECOPY:    &ExtCodeCopyOpCode{},
	vm.RETURNDATASIZE: &ReturnDataSizeOpCode{},
	vm.RETURNDATACOPY: &ReturnDataCopyOpCode{},
	vm.EXTCODEHASH:    &ExtCodeHashOpCode{},
	vm.BLOCKHASH:      &BlockHashOpCode{},
